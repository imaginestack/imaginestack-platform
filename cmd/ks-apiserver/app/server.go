...
import (
	...
	"imaginekube.com/imaginekube/cmd/ks-apiserver/app/options"
...
func NewAPIServerCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		Use: "ks-apiserver",
		Long: `The ImagineKube API server validates and configures data for the API objects. 
...
cluster's shared state through which all other components interact.`,
	...
	versionCmd := &cobra.Command{
		Use:   "version",
		Short: "Print the version of ImagineKube ks-apiserver",
