...
import (
	...
	"imaginekube.com/imaginekube/pkg/apiserver"
	apiserverconfig "imaginekube.com/imaginekube/pkg/apiserver/config"
	"imaginekube.com/imaginekube/pkg/informers"
	genericoptions "imaginekube.com/imaginekube/pkg/server/options"
	"imaginekube.com/imaginekube/pkg/simple/client/alerting"
	auditingclient "imaginekube.com/imaginekube/pkg/simple/client/auditing/elasticsearch"
	"imaginekube.com/imaginekube/pkg/simple/client/cache"

	"imaginekube.com/imaginekube/pkg/simple/client/devops/jenkins"
	eventsclient "imaginekube.com/imaginekube/pkg/simple/client/events/elasticsearch"
	"imaginekube.com/imaginekube/pkg/simple/client/k8s"
	esclient "imaginekube.com/imaginekube/pkg/simple/client/logging/elasticsearch"
	"imaginekube.com/imaginekube/pkg/simple/client/monitoring/metricsserver"
	"imaginekube.com/imaginekube/pkg/simple/client/monitoring/prometheus"
	"imaginekube.com/imaginekube/pkg/simple/client/s3"
	fakes3 "imaginekube.com/imaginekube/pkg/simple/client/s3/fake"
...
func (s *ServerRunOptions) NewAPIServer(stopCh <-chan struct{}) (*apiserver.APIServer, error) {
	...
	informerFactory := informers.NewInformerFactories(kubernetesClient.Kubernetes(), kubernetesClient.ImagineKube(),
	...
	if s.MonitoringOptions == nil || len(s.MonitoringOptions.Endpoint) == 0 {
		return nil, fmt.Errorf("moinitoring service address in configuration MUST not be empty, please check configmap/imaginekube-config in imaginekube-system namespace")
	} else {
	...
	if s.Config.MultiClusterOptions.Enable {
		cc := clusterclient.NewClusterClient(informerFactory.ImagineKubeSharedInformerFactory().Cluster().V1alpha1().Clusters())
		apiServer.ClusterClient = cc
	}

	apiServer.OpenpitrixClient = openpitrixv1.NewOpenpitrixClient(informerFactory, apiServer.KubernetesClient.ImagineKube(), s.OpenPitrixOptions, apiServer.ClusterClient)
