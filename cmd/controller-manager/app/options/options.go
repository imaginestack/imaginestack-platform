...
type ImagineKubeControllerManagerOptions struct {
	...
	// ImagineKube is using sigs.k8s.io/application as fundamental object to implement Application Management.
	// There are other projects also built on sigs.k8s.io/application, when ImagineKube installed along side
	...
	//    For example
	//      "imaginekube.com/creator=" means reconcile applications with this label key
	//      "!imaginekube.com/creator" means exclude applications with this key
...
func NewImagineKubeControllerManagerOptions() *ImagineKubeControllerManagerOptions {
	s := &ImagineKubeControllerManagerOptions{
...
func (s *ImagineKubeControllerManagerOptions) Flags(allControllerNameSelectors []string) cliflag.NamedFlagSets {
...
func (o *ImagineKubeControllerManagerOptions) Validate(allControllerNameSelectors []string) []error {
	var errs []error
...
func (o *ImagineKubeControllerManagerOptions) IsControllerEnabled(name string) bool {
	hasStar := false
...
func (s *ImagineKubeControllerManagerOptions) bindLeaderElectionFlags(l *leaderelection.LeaderElectionConfig, fs *pflag.FlagSet) {
...
func (s *ImagineKubeControllerManagerOptions) MergeConfig(cfg *controllerconfig.Config) {
