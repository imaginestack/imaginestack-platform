...
import (
	...
	iamv1alpha2 "imaginekube.com/imaginekube/pkg/kapis/iam/v1alpha2"
	...
	openpitrixv2 "imaginekube.com/imaginekube/pkg/kapis/openpitrix/v2alpha1"
	...
	resourcesv1alpha3 "imaginekube.com/imaginekube/pkg/kapis/resources/v1alpha3"
	metricsv1alpha2 "imaginekube.com/imaginekube/pkg/kapis/servicemesh/metrics/v1alpha2"
...
func generateSwaggerJson() []byte {
	...
	urlruntime.Must(clusterkapisv1alpha1.AddToContainer(container, clientsets.ImagineKube(), informerFactory.KubernetesSharedInformerFactory(),
		informerFactory.ImagineKubeSharedInformerFactory(), "", "", ""))
	urlruntime.Must(kapisdevops.AddToContainer(container, ""))
	urlruntime.Must(iamv1alpha2.AddToContainer(container, nil, nil, group.New(informerFactory, clientsets.ImagineKube(), clientsets.Kubernetes()), nil))
...
func enrichSwaggerObject(swo *spec.Swagger) {
	swo.Info = &spec.Info{
		InfoProps: spec.InfoProps{
			Title:       "ImagineKube",
			Description: "ImagineKube OpenAPI",
			Version:     version.Get().GitVersion,
			Contact: &spec.ContactInfo{
				ContactInfoProps: spec.ContactInfoProps{
					Name:  "ImagineKube",
					URL:   "https://imaginekube.com/",
