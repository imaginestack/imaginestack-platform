...
import (
	...
	"imaginekube.com/monitoring-dashboard/api/v1alpha1"
	v1alpha1panels "imaginekube.com/monitoring-dashboard/api/v1alpha1/panels"
	v1alpha2panels "imaginekube.com/monitoring-dashboard/api/v1alpha2/panels"
	v1alpha2templatings "imaginekube.com/monitoring-dashboard/api/v1alpha2/templatings"
	"imaginekube.com/monitoring-dashboard/api/v1alpha2/time"
