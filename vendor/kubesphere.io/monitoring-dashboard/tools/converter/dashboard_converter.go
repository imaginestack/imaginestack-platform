...
import (
	...
	v1alpha2 "imaginekube.com/monitoring-dashboard/api/v1alpha2"
	ansModel "imaginekube.com/monitoring-dashboard/api/v1alpha2/annotations"
	panelsModel "imaginekube.com/monitoring-dashboard/api/v1alpha2/panels"
	templatingsModel "imaginekube.com/monitoring-dashboard/api/v1alpha2/templatings"
)
