...
import (
	...
	"imaginekube.com/imaginekube/pkg/apiserver/auditing/v1alpha1"
...
const (
	...
	WebhookURL           = "https://kube-auditing-webhook-svc.imaginekube-logging-system.svc:6443/audit/webhook/event"
)
