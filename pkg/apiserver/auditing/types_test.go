...
import (
	...
	v1alpha12 "imaginekube.com/imaginekube/pkg/apiserver/auditing/v1alpha1"
...
func TestGetAuditLevel(t *testing.T) {
	...
	a := auditing{
		webhookLister: fakeInformerFactory.ImagineKubeSharedInformerFactory().Auditing().V1alpha1().Webhooks().Lister(),
	}

	err := fakeInformerFactory.ImagineKubeSharedInformerFactory().Auditing().V1alpha1().Webhooks().Informer().GetIndexer().Add(webhook)
	if err != nil {
		panic(err)
	}
...
func TestAuditing_LogRequestObject(t *testing.T) {
	...
	req := &http.Request{}
	u, err := url.Parse("http://139.198.121.143:32306//kapis/tenant.imaginekube.com/v1alpha2/workspaces")
	if err != nil {
		panic(err)
	}
	...
	info := &request.RequestInfo{
		RequestInfo: &k8srequest.RequestInfo{
			...
			Path:              "/kapis/tenant.imaginekube.com/v1alpha2/workspaces",
			Verb:              "create",
			APIGroup:          "tenant.imaginekube.com",
			APIVersion:        "v1alpha2",
			Resource:          "workspaces",
			Name:              "test",
		},
	...
	expectedEvent := &v1alpha12.Event{
		Event: audit.Event{
			...
			RequestURI:               "/kapis/tenant.imaginekube.com/v1alpha2/workspaces",
