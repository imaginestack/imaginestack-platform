	...
	staticRoles := StaticRoles{
		roles: []*rbacv1.Role{
			...
			},
			{
				ObjectMeta: metav1.ObjectMeta{
					Namespace: "imaginekube-system",
					Name:      "imaginekube-system-viewer",
				},
				Rules: []rbacv1.PolicyRule{
					{
		...
		roleBindings: []*rbacv1.RoleBinding{
			{
				...
				Subjects: []rbacv1.Subject{
					{Kind: rbacv1.UserKind, Name: "imaginekube-system-admin"},
				},
				RoleRef: rbacv1.RoleRef{APIGroup: rbacv1.GroupName, Kind: "Role", Name: "imaginekube-system-admin"},
			},
			{
				ObjectMeta: metav1.ObjectMeta{
					Namespace: "imaginekube-system",
				...
				RoleRef: rbacv1.RoleRef{APIGroup: rbacv1.GroupName, Kind: "Role", Name: "imaginekube-system-viewer"},
			},
		},
		workspaceRoleBindings: []*iamv1alpha2.WorkspaceRoleBinding{
			{
...
func newMockRBACAuthorizer(staticRoles *StaticRoles) (*RBACAuthorizer, error) {
	...
	ksInformerFactory := fakeInformerFactory.ImagineKubeSharedInformerFactory()
