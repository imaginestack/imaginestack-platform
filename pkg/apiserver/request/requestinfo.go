...
type RequestInfo struct {
	*k8srequest.RequestInfo
	...
	// IsKubernetesRequest indicates whether or not the request should be handled by kubernetes or imaginekube
...
func (r *RequestInfoFactory) NewRequestInfo(req *http.Request) (*RequestInfo, error) {
	...
	// URL forms: /api/v1/watch/namespaces?labelSelector=imaginekube.com/workspace=system-workspace
