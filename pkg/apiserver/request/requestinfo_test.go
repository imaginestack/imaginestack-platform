...
func TestRequestInfoFactory_NewRequestInfo(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			url:                       "/kapis/resources.imaginekube.com/v1alpha3/workspaces/workspace1/namespaces",
			method:                    http.MethodGet,
			expectedErr:               nil,
			expectedVerb:              "list",
		...
		},
		{
			...
			url:                       "/kapis/clusters/gondor/resources.imaginekube.com/v1alpha3/workspaces/workspace1/namespaces",
			method:                    http.MethodGet,
			expectedErr:               nil,
			expectedVerb:              "list",
			expectedResource:          "namespaces",
		...
		{
			name:                      "list clusters",
			url:                       "/apis/cluster.imaginekube.com/v1alpha1/clusters",
			method:                    http.MethodGet,
			expectedErr:               nil,
			expectedVerb:              "list",
		...
		},
		{
			...
			url:                       "/apis/cluster.imaginekube.com/v1alpha1/clusters/gondor",
			method:                    http.MethodGet,
			expectedErr:               nil,
			expectedVerb:              "get",
			expectedResource:          "clusters",
		...
		{
			name:                      "",
			url:                       "/kapis/tenant.imaginekube.com/v1alpha2/workspaces",
			method:                    http.MethodGet,
			expectedErr:               nil,
			expectedVerb:              "list",
			expectedNamespace:         "",
		...
		{
			name:                      "imaginekube api without clusters",
			url:                       "/kapis/foo/bar/",
			method:                    http.MethodPost,
			expectedErr:               nil,
			expectedVerb:              "POST",
