	...
	Context("OIDC", func() {
		...
		It("should configure successfully", func() {
			config := options.DynamicOptions{
				...
				"redirectURL":        "https://ks-console.imaginekube-system.svc/oauth/redirect/oidc",
		...
		It("should login successfully", func() {
			url, _ := url.Parse("https://ks-console.imaginekube-system.svc/oauth/redirect/oidc?code=00000")
