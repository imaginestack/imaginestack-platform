...
redirectURL: "https://ks-console.imaginekube-system.svc/oauth/redirect/github"
scopes:
- user
`
		...
		It("should login successfully", func() {
			url, _ := url.Parse("https://ks-console.imaginekube-system.svc/oauth/redirect/test?code=00000")
			...
			Expect(identity.GetEmail()).Should(Equal("test@imaginekube.com"))
		})
	})
})
