...
import (
	...
	_ "imaginekube.com/imaginekube/pkg/apiserver/authentication/identityprovider/aliyunidaas"
	_ "imaginekube.com/imaginekube/pkg/apiserver/authentication/identityprovider/cas"
	_ "imaginekube.com/imaginekube/pkg/apiserver/authentication/identityprovider/github"
	_ "imaginekube.com/imaginekube/pkg/apiserver/authentication/identityprovider/ldap"
	_ "imaginekube.com/imaginekube/pkg/apiserver/authentication/identityprovider/oidc"
...
type Options struct {
	...
	// retention login history, records beyond this amount will be deleted
	// LoginHistoryMaximumEntries restricts for all imaginekube accounts and must be greater than AuthenticateRateLimiterMaxTries
...
func NewOptions() *Options {
	return &Options{
		...
		MultipleLogin:                   false,
		JwtSecret:                       "",
		KubectlImage:                    "imaginekube/kubectl:v1.0.0",
	}
}
