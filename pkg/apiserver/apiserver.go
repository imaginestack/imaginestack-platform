...
import (
	...
	audit "imaginekube.com/imaginekube/pkg/apiserver/auditing"
	"imaginekube.com/imaginekube/pkg/apiserver/authentication/authenticators/basic"
	"imaginekube.com/imaginekube/pkg/apiserver/authentication/authenticators/jwt"
	"imaginekube.com/imaginekube/pkg/apiserver/authentication/request/anonymous"
	"imaginekube.com/imaginekube/pkg/apiserver/authentication/request/basictoken"
	"imaginekube.com/imaginekube/pkg/apiserver/authentication/request/bearertoken"
	"imaginekube.com/imaginekube/pkg/apiserver/authentication/token"
	...
	"imaginekube.com/imaginekube/pkg/apiserver/authorization/authorizerfactory"
	"imaginekube.com/imaginekube/pkg/apiserver/authorization/path"
	"imaginekube.com/imaginekube/pkg/apiserver/authorization/rbac"
	unionauthorizer "imaginekube.com/imaginekube/pkg/apiserver/authorization/union"
	apiserverconfig "imaginekube.com/imaginekube/pkg/apiserver/config"
	"imaginekube.com/imaginekube/pkg/apiserver/filters"
	"imaginekube.com/imaginekube/pkg/apiserver/request"
	"imaginekube.com/imaginekube/pkg/informers"
	alertingv1 "imaginekube.com/imaginekube/pkg/kapis/alerting/v1"
	alertingv2alpha1 "imaginekube.com/imaginekube/pkg/kapis/alerting/v2alpha1"
	alertingv2beta1 "imaginekube.com/imaginekube/pkg/kapis/alerting/v2beta1"
	clusterkapisv1alpha1 "imaginekube.com/imaginekube/pkg/kapis/cluster/v1alpha1"
	configv1alpha2 "imaginekube.com/imaginekube/pkg/kapis/config/v1alpha2"
	kapisdevops "imaginekube.com/imaginekube/pkg/kapis/devops"
	edgeruntimev1alpha1 "imaginekube.com/imaginekube/pkg/kapis/edgeruntime/v1alpha1"
	gatewayv1alpha1 "imaginekube.com/imaginekube/pkg/kapis/gateway/v1alpha1"
	iamapi "imaginekube.com/imaginekube/pkg/kapis/iam/v1alpha2"
	kubeedgev1alpha1 "imaginekube.com/imaginekube/pkg/kapis/kubeedge/v1alpha1"
	meteringv1alpha1 "imaginekube.com/imaginekube/pkg/kapis/metering/v1alpha1"
	monitoringv1alpha3 "imaginekube.com/imaginekube/pkg/kapis/monitoring/v1alpha3"
	networkv1alpha2 "imaginekube.com/imaginekube/pkg/kapis/network/v1alpha2"
	notificationv1 "imaginekube.com/imaginekube/pkg/kapis/notification/v1"
	notificationkapisv2beta1 "imaginekube.com/imaginekube/pkg/kapis/notification/v2beta1"
	notificationkapisv2beta2 "imaginekube.com/imaginekube/pkg/kapis/notification/v2beta2"
	"imaginekube.com/imaginekube/pkg/kapis/oauth"
	openpitrixv1 "imaginekube.com/imaginekube/pkg/kapis/openpitrix/v1"
	openpitrixv2alpha1 "imaginekube.com/imaginekube/pkg/kapis/openpitrix/v2alpha1"
	operationsv1alpha2 "imaginekube.com/imaginekube/pkg/kapis/operations/v1alpha2"
	resourcesv1alpha2 "imaginekube.com/imaginekube/pkg/kapis/resources/v1alpha2"
	resourcev1alpha3 "imaginekube.com/imaginekube/pkg/kapis/resources/v1alpha3"
	servicemeshv1alpha2 "imaginekube.com/imaginekube/pkg/kapis/servicemesh/metrics/v1alpha2"
	tenantv1alpha2 "imaginekube.com/imaginekube/pkg/kapis/tenant/v1alpha2"
	tenantv1alpha3 "imaginekube.com/imaginekube/pkg/kapis/tenant/v1alpha3"
	terminalv1alpha2 "imaginekube.com/imaginekube/pkg/kapis/terminal/v1alpha2"
	"imaginekube.com/imaginekube/pkg/kapis/version"
	"imaginekube.com/imaginekube/pkg/models/auth"
	"imaginekube.com/imaginekube/pkg/models/iam/am"
	"imaginekube.com/imaginekube/pkg/models/iam/group"
	...
	resourcev1beta1 "imaginekube.com/imaginekube/pkg/models/resources/v1beta1"
	"imaginekube.com/imaginekube/pkg/server/healthz"
	...
	"imaginekube.com/imaginekube/pkg/simple/client/devops"
...
type APIServer struct {
	// number of imaginekube apiserver
	ServerCount int
...
func (s *APIServer) PrepareRun(stopCh <-chan struct{}) error {
	...
	s.installImagineKubeAPIs(stopCh)
	s.installMetricsAPI()
	s.installHealthz()
...
// Install all imaginekube api groups
// Installation happens before all informers start to cache objects, so
//
//	any attempt to list objects using listers will get empty results.
func (s *APIServer) installImagineKubeAPIs(stopCh <-chan struct{}) {
	imOperator := im.NewOperator(s.KubernetesClient.ImagineKube(),
		user.New(s.InformerFactory.ImagineKubeSharedInformerFactory(),
			s.InformerFactory.KubernetesSharedInformerFactory()),
		loginrecord.New(s.InformerFactory.ImagineKubeSharedInformerFactory()),
		s.Config.AuthenticationOptions)
	amOperator := am.NewOperator(s.KubernetesClient.ImagineKube(),
	...
	urlruntime.Must(openpitrixv1.AddToContainer(s.container, s.InformerFactory, s.KubernetesClient.ImagineKube(), s.Config.OpenPitrixOptions, s.OpenpitrixClient))
	urlruntime.Must(openpitrixv2alpha1.AddToContainer(s.container, s.InformerFactory, s.KubernetesClient.ImagineKube(), s.Config.OpenPitrixOptions))
	...
	urlruntime.Must(tenantv1alpha2.AddToContainer(s.container, s.InformerFactory, s.KubernetesClient.Kubernetes(),
		s.KubernetesClient.ImagineKube(), s.EventsClient, s.LoggingClient, s.AuditingClient, amOperator, imOperator, rbacAuthorizer, s.MonitoringClient, s.RuntimeCache, s.Config.MeteringOptions, s.OpenpitrixClient))
	...
	urlruntime.Must(clusterkapisv1alpha1.AddToContainer(s.container,
		s.KubernetesClient.ImagineKube(),
		s.InformerFactory.KubernetesSharedInformerFactory(),
		s.InformerFactory.ImagineKubeSharedInformerFactory(),
	...
	urlruntime.Must(iamapi.AddToContainer(s.container, imOperator, amOperator,
		group.New(s.InformerFactory, s.KubernetesClient.ImagineKube(), s.KubernetesClient.Kubernetes()),
		rbacAuthorizer))

	userLister := s.InformerFactory.ImagineKubeSharedInformerFactory().Iam().V1alpha2().Users().Lister()
	urlruntime.Must(oauth.AddToContainer(s.container, imOperator,
		...
		auth.NewPasswordAuthenticator(s.KubernetesClient.ImagineKube(), userLister, s.Config.AuthenticationOptions),
		auth.NewOAuthAuthenticator(s.KubernetesClient.ImagineKube(), userLister, s.Config.AuthenticationOptions),
		auth.NewLoginRecorder(s.KubernetesClient.ImagineKube(), userLister),
		s.Config.AuthenticationOptions))
	...
	if s.Config.NotificationOptions.IsEnabled() {
		...
		urlruntime.Must(notificationkapisv2beta2.AddToContainer(s.container, s.InformerFactory, s.KubernetesClient.Kubernetes(),
			s.KubernetesClient.ImagineKube(), s.Config.NotificationOptions))
	}
...
func (s *APIServer) buildHandlerChain(stopCh <-chan struct{}) {
	...
	case authorization.RBAC:
		excludedPaths := []string{"/oauth/*", "/kapis/config.imaginekube.com/*", "/kapis/version", "/kapis/metrics", "/healthz"}
	...
	userLister := s.InformerFactory.ImagineKubeSharedInformerFactory().Iam().V1alpha2().Users().Lister()
	loginRecorder := auth.NewLoginRecorder(s.KubernetesClient.ImagineKube(), userLister)
...
func (s *APIServer) waitForResourceSync(ctx context.Context) error {
	...
	ksGVRs := map[schema.GroupVersion][]string{
		{Group: "tenant.imaginekube.com", Version: "v1alpha1"}: {
			"workspaces",
		},
		{Group: "tenant.imaginekube.com", Version: "v1alpha2"}: {
			"workspacetemplates",
		},
		{Group: "iam.imaginekube.com", Version: "v1alpha2"}: {
			"users",
			"globalroles",
			"globalrolebindings",
			"groups",
		...
		{Group: "cluster.imaginekube.com", Version: "v1alpha1"}: {
			"clusters",
		},
		{Group: "network.imaginekube.com", Version: "v1alpha1"}: {
			"ippools",
		},
	}
	if s.Config.NotificationOptions.IsEnabled() {
		ksGVRs[schema.GroupVersion{Group: "notification.imaginekube.com", Version: "v2beta1"}] = []string{
			notificationv2beta1.ResourcesPluralConfig,
			notificationv2beta1.ResourcesPluralReceiver,
		}
		ksGVRs[schema.GroupVersion{Group: "notification.imaginekube.com", Version: "v2beta2"}] = []string{
	...
	if s.DevopsClient != nil {
		ksGVRs[schema.GroupVersion{Group: "devops.imaginekube.com", Version: "v1alpha1"}] = []string{
			"s2ibinaries",
			"s2ibuildertemplates",
			"s2iruns",
			"s2ibuilders",
		}
		ksGVRs[schema.GroupVersion{Group: "devops.imaginekube.com", Version: "v1alpha3"}] = []string{
			"devopsprojects",
			"pipelines",
		}
	}
	...
	if s.KubernetesClient.Istio() != nil {
		ksGVRs[schema.GroupVersion{Group: "servicemesh.imaginekube.com", Version: "v1alpha2"}] = []string{
			"strategies",
			"servicepolicies",
		}
	}
	...
	if err := waitForCacheSync(s.KubernetesClient.Kubernetes().Discovery(),
		s.InformerFactory.ImagineKubeSharedInformerFactory(),
		func(resource schema.GroupVersionResource) (interface{}, error) {
			return s.InformerFactory.ImagineKubeSharedInformerFactory().ForResource(resource)
		},
