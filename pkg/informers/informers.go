...
// InformerFactory is a group all shared informer factories which imaginekube needed
// callers should check if the return value is nil
type InformerFactory interface {
	KubernetesSharedInformerFactory() k8sinformers.SharedInformerFactory
	ImagineKubeSharedInformerFactory() ksinformers.SharedInformerFactory
...
func (f *informerFactories) ImagineKubeSharedInformerFactory() ksinformers.SharedInformerFactory {
