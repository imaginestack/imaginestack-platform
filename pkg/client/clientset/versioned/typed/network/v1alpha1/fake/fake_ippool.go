...
var ippoolsResource = schema.GroupVersionResource{Group: "network.imaginekube.com", Version: "v1alpha1", Resource: "ippools"}

var ippoolsKind = schema.GroupVersionKind{Group: "network.imaginekube.com", Version: "v1alpha1", Kind: "IPPool"}
