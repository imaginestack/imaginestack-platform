...
import (
	...
	v2beta1 "imaginekube.com/api/alerting/v2beta1"
	v1alpha1 "imaginekube.com/api/application/v1alpha1"
	...
	v1alpha3 "imaginekube.com/api/devops/v1alpha3"
...
func (f *sharedInformerFactory) ForResource(resource schema.GroupVersionResource) (GenericInformer, error) {
	switch resource {
	// Group=alerting.imaginekube.com, Version=v2beta1
	...
	case v2beta1.SchemeGroupVersion.WithResource("rulegroups"):
		...
		// Group=application.imaginekube.com, Version=v1alpha1
	...
	case v1alpha1.SchemeGroupVersion.WithResource("helmrepos"):
		...
		// Group=auditing.imaginekube.com, Version=v1alpha1
	...
	case clusterv1alpha1.SchemeGroupVersion.WithResource("clusters"):
		...
		// Group=devops.imaginekube.com, Version=v1alpha1
	...
	case networkv1alpha1.SchemeGroupVersion.WithResource("namespacenetworkpolicies"):
		...
		// Group=notification.imaginekube.com, Version=v2beta1
	...
	case notificationv2beta1.SchemeGroupVersion.WithResource("receivers"):
		...
		// Group=notification.imaginekube.com, Version=v2beta2
	...
	case v2beta2.SchemeGroupVersion.WithResource("silences"):
		...
		// Group=quota.imaginekube.com, Version=v1alpha2
	case quotav1alpha2.SchemeGroupVersion.WithResource("resourcequotas"):
		...
		// Group=servicemesh.imaginekube.com, Version=v1alpha2
	...
	case servicemeshv1alpha2.SchemeGroupVersion.WithResource("strategies"):
		...
		// Group=storage.imaginekube.com, Version=v1alpha1
