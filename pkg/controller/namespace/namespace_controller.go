...
// +kubebuilder:rbac:groups=tenant.imaginekube.com,resources=workspaces,verbs=get;list;watch
...
func (r *Reconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	finalizer := "finalizers.imaginekube.com/namespaces"
	...
	// Bind to workspace if the namespace created by imaginekube
	...
	// Initialize roles for devops/project namespaces if created by imaginekube
...
func (r *Reconciler) deleteGateway(ctx context.Context, logger logr.Logger, namespace string) error {
	...
	gateway.SetGroupVersionKind(schema.GroupVersionKind{Group: "gateway.imaginekube.com", Version: "v1alpha1", Kind: "Gateway"})
