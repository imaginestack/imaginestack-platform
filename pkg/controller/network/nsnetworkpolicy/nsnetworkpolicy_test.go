...
import (
	...
	netv1alpha1 "imaginekube.com/api/network/v1alpha1"
	wkspv1alpha1 "imaginekube.com/api/tenant/v1alpha1"
...
spec:
  ...
  ingress:
    - from:
        ...
        - namespaceSelector:
            matchLabels:
              "imaginekube.com/namespace" : "imaginekube-monitoring-system"
  policyTypes:
    - Ingress`
...
metadata:
  labels:
    imaginekube.com/workspace: testworkspace
  name: testns
spec:
  finalizers:
  - kubernetes
...
var _ = Describe("Nsnetworkpolicy", func() {
	BeforeEach(func() {
		...
		nsnpOptions.NSNPOptions.AllowedIngressNamespaces = append(nsnpOptions.NSNPOptions.AllowedIngressNamespaces, "imaginekube-monitoring-system")
  ...
  ingress:
    - from:
        - podSelector:
          ...
          namespaceSelector:
            matchLabels:
              imaginekube.com/namespace: testns
  policyTypes:
    - Ingress
`
		obj2 := &netv1.NetworkPolicy{}
