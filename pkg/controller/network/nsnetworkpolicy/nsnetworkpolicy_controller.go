...
import (
	...
	workspacev1alpha1 "imaginekube.com/api/tenant/v1alpha1"

	ksnetclient "imaginekube.com/imaginekube/pkg/client/clientset/versioned/typed/network/v1alpha1"
	nspolicy "imaginekube.com/imaginekube/pkg/client/informers/externalversions/network/v1alpha1"
	workspace "imaginekube.com/imaginekube/pkg/client/informers/externalversions/tenant/v1alpha1"
	"imaginekube.com/imaginekube/pkg/constants"
	"imaginekube.com/imaginekube/pkg/controller/network/nsnetworkpolicy/provider"
	options "imaginekube.com/imaginekube/pkg/simple/client/network"
)
...
const (
	...
	NamespaceNPAnnotationKey     = "imaginekube.com/network-isolate"
	NamespaceNPAnnotationEnabled = "enabled"

	NodeNSNPAnnotationKey = "imaginekube.com/snat-node-ips"
...
// namespacenpController implements the Controller interface for managing imaginekube network policies
