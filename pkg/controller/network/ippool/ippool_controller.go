...
import (
	...
	imaginekubeclient "imaginekube.com/imaginekube/pkg/client/clientset/versioned"
	ksinformers "imaginekube.com/imaginekube/pkg/client/informers/externalversions"
	networkInformer "imaginekube.com/imaginekube/pkg/client/informers/externalversions/network/v1alpha1"
	tenantv1alpha1informers "imaginekube.com/imaginekube/pkg/client/informers/externalversions/tenant/v1alpha1"
	"imaginekube.com/imaginekube/pkg/constants"
	"imaginekube.com/imaginekube/pkg/controller/network/utils"
	"imaginekube.com/imaginekube/pkg/controller/network/webhooks"
	"imaginekube.com/imaginekube/pkg/simple/client/network/ippool"
)
...
type IPPoolController struct {
	...
	imaginekubeClient imaginekubeclient.Interface
}
...
func (c *IPPoolController) addFinalizer(pool *networkv1alpha1.IPPool) error {
	...
	pool, err := c.imaginekubeClient.NetworkV1alpha1().IPPools().Update(context.TODO(), clone, metav1.UpdateOptions{})
	if err != nil {
...
func (c *IPPoolController) ValidateCreate(obj runtime.Object) error {
	...
	pools, err := c.imaginekubeClient.NetworkV1alpha1().IPPools().List(context.TODO(), metav1.ListOptions{
...
func (c *IPPoolController) disableIPPool(old *networkv1alpha1.IPPool) error {
	...
	_, err := c.imaginekubeClient.NetworkV1alpha1().IPPools().Update(context.TODO(), clone, metav1.UpdateOptions{})
...
func (c *IPPoolController) updateIPPoolStatus(old *networkv1alpha1.IPPool) error {
	...
	_, err = c.imaginekubeClient.NetworkV1alpha1().IPPools().UpdateStatus(context.TODO(), new, metav1.UpdateOptions{})
	if err != nil {
...
func NewIPPoolController(
	imaginekubeInformers ksinformers.SharedInformerFactory,
	...
	c := &IPPoolController{
		...
		client:           client,
		imaginekubeClient: imaginekubeClient,
		provider:         provider,
	}
	c.ippoolInformer = imaginekubeInformers.Network().V1alpha1().IPPools()
	c.ippoolSynced = c.ippoolInformer.Informer().HasSynced
	c.ipamblockInformer = imaginekubeInformers.Network().V1alpha1().IPAMBlocks()
	c.ipamblockSynced = c.ipamblockInformer.Informer().HasSynced
	c.wsInformer = imaginekubeInformers.Tenant().V1alpha1().Workspaces()
