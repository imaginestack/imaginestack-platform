...
const (
	HelmCategoryFinalizer = "helmcategories.application.imaginekube.com"
)
...
// +kubebuilder:rbac:groups=application.imaginekube.com,resources=helmcategories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=application.imaginekube.com,resources=helmcategories/status,verbs=get;update;patch
