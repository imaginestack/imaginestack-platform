...
import (
	...
	"imaginekube.com/imaginekube/pkg/simple/client/openpitrix/helmwrapper"
...
const (
	HelmReleaseFinalizer = "helmrelease.application.imaginekube.com"
...
// +kubebuilder:rbac:groups=application.imaginekube.com,resources=helmreleases,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=application.imaginekube.com,resources=helmreleases/status,verbs=get;update;patch
