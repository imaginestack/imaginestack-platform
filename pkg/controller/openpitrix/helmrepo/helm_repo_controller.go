...
const (
	HelmRepoFinalizer = "helmrepo.application.imaginekube.com"
)
...
// +kubebuilder:rbac:groups=application.imaginekube.com,resources=helmrepos,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=application.imaginekube.com,resources=helmrepos/status,verbs=get;update;patch
