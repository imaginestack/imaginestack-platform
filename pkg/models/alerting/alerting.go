...
import (
	...
	"imaginekube.com/imaginekube/pkg/api/alerting/v2alpha1"
	"imaginekube.com/imaginekube/pkg/constants"
	"imaginekube.com/imaginekube/pkg/informers"
	"imaginekube.com/imaginekube/pkg/models/alerting/rules"
	"imaginekube.com/imaginekube/pkg/simple/client/alerting"
)

const (
	rulerNamespace = constants.ImagineKubeMonitoringNamespace
)
