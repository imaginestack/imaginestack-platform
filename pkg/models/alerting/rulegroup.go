...
import (
	...
	kapialertingv2beta1 "imaginekube.com/imaginekube/pkg/api/alerting/v2beta1"
	"imaginekube.com/imaginekube/pkg/apiserver/query"
	alertinglisters "imaginekube.com/imaginekube/pkg/client/listers/alerting/v2beta1"
	controller "imaginekube.com/imaginekube/pkg/controller/alerting"
...
func NewRuleGroupOperator(informers informers.InformerFactory, ruleClient alerting.RuleClient) RuleGroupOperator {
	return &ruleGroupOperator{
		...
		ruleGroupLister:        informers.ImagineKubeSharedInformerFactory().Alerting().V2beta1().RuleGroups().Lister(),
		clusterRuleGroupLister: informers.ImagineKubeSharedInformerFactory().Alerting().V2beta1().ClusterRuleGroups().Lister(),
		globalRuleGroupLister:  informers.ImagineKubeSharedInformerFactory().Alerting().V2beta1().GlobalRuleGroups().Lister(),
	}
}
