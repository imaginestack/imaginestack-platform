...
func New(informers informers.InformerFactory, ksclient imaginekube.Interface, k8sclient kubernetes.Interface) GroupOperator {
...
// labelGroupWithWorkspaceName adds a imaginekube.com/workspace=[workspaceName] label to namespace which
