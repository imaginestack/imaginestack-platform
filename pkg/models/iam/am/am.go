...
import (
	...
	devopslisters "imaginekube.com/imaginekube/pkg/client/listers/devops/v1alpha3"
	"imaginekube.com/imaginekube/pkg/informers"
	resourcev1alpha3 "imaginekube.com/imaginekube/pkg/models/resources/v1alpha3"
...
func NewReadOnlyOperator(factory informers.InformerFactory, devopsClient devops.Interface) AccessManagementInterface {
	operator := &amOperator{
		globalRoleBindingGetter:    globalrolebinding.New(factory.ImagineKubeSharedInformerFactory()),
		workspaceRoleBindingGetter: workspacerolebinding.New(factory.ImagineKubeSharedInformerFactory()),
		...
		globalRoleGetter:           globalrole.New(factory.ImagineKubeSharedInformerFactory()),
		workspaceRoleGetter:        workspacerole.New(factory.ImagineKubeSharedInformerFactory()),
	...
	if devopsClient != nil {
		operator.devopsProjectLister = factory.ImagineKubeSharedInformerFactory().Devops().V1alpha3().DevOpsProjects().Lister()
	}
	return operator
}

func NewOperator(ksClient imaginekube.Interface, k8sClient kubernetes.Interface, factory informers.InformerFactory, devopsClient devops.Interface) AccessManagementInterface {
