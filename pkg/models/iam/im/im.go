...
func NewOperator(ksClient imaginekube.Interface, userGetter resources.Interface, loginRecordGetter resources.Interface, options *authentication.Options) IdentityManagementInterface {
	im := &imOperator{
		ksClient:          ksClient,
