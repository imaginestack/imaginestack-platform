...
import (
	...
	"imaginekube.com/imaginekube/pkg/simple/client/s3/fake"
)
...
func prepareAppOperator() ApplicationInterface {
	...
	return newApplicationOperator(reposcache.NewReposCache(), fakeInformerFactory.ImagineKubeSharedInformerFactory(), ksClient, fake.NewFakeS3())
}
