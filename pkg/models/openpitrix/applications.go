...
import (
	...
	v1alpha13 "imaginekube.com/imaginekube/pkg/client/clientset/versioned/typed/application/v1alpha1"
	"imaginekube.com/imaginekube/pkg/client/informers/externalversions"
	listers_v1alpha1 "imaginekube.com/imaginekube/pkg/client/listers/application/v1alpha1"
	...
	"imaginekube.com/imaginekube/pkg/simple/client/openpitrix/helmrepoindex"
	"imaginekube.com/imaginekube/pkg/simple/client/s3"
	"imaginekube.com/imaginekube/pkg/utils/idutils"
...
func (c *applicationOperator) DoAppAction(appId string, request *ActionRequest) error {
	...
	// All the app belonging to a built-in repo have a label `application.imaginekube.com/repo-id`, and the value should be `builtin-stable` or else.
