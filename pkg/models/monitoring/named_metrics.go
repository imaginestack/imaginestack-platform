...
const (
	ImagineKubeWorkspaceCount = "imaginekube_workspace_count"
	ImagineKubeUserCount      = "imaginekube_user_count"
	ImagineKubeClusterCount   = "imaginekube_cluser_count"
	ImagineKubeAppTmplCount   = "imaginekube_app_template_count"
