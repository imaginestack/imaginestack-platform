...
const (
	nodeCPURequests                                 = "node.imaginekube.com/cpu-requests"
	nodeMemoryRequests                              = "node.imaginekube.com/memory-requests"
	nodeCPULimits                                   = "node.imaginekube.com/cpu-limits"
	nodeMemoryLimits                                = "node.imaginekube.com/memory-limits"
	nodeCPURequestsFraction                         = "node.imaginekube.com/cpu-requests-fraction"
	nodeCPULimitsFraction                           = "node.imaginekube.com/cpu-limits-fraction"
	nodeMemoryRequestsFraction                      = "node.imaginekube.com/memory-requests-fraction"
	nodeMemoryLimitsFraction                        = "node.imaginekube.com/memory-limits-fraction"
...
func (c *nodesGetter) Get(_, name string) (runtime.Object, error) {
	...
	// Refer:
	// https://github.com/imaginekube/imaginekube/issues/4357
	// https://github.com/imaginekube/imaginekube/issues/3469
	// https://github.com/imaginekube/imaginekube/pull/4599
