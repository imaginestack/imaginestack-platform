...
func NewPasswordAuthenticator(ksClient imaginekube.Interface,
...
func (p *passwordAuthenticator) Authenticate(_ context.Context, provider, username, password string) (authuser.Info, string, error) {
	...
	return p.authByImagineKube(username, password)
}

// authByImagineKube authenticate by the imaginekube user
func (p *passwordAuthenticator) authByImagineKube(username, password string) (authuser.Info, string, error) {
