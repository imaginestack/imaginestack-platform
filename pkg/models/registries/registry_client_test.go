...
func TestCreateRegistryClient(t *testing.T) {
	...
	testImages := []imageInfo{
		{Domain: "imaginekube.com", ExDomain: "imaginekube.com", ExUrl: "https://imaginekube.com", UseSSL: true},
		...
		{Domain: "harbor.devops.imaginekube.local:30280", ExDomain: "harbor.devops.imaginekube.local:30280", ExUrl: "http://harbor.devops.imaginekube.local:30280", UseSSL: false},
