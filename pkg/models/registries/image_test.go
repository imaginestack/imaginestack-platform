...
func TestParseImage(t *testing.T) {
	...
	testImages := []testImage{
		{inputImageName: "dockerhub.qingcloud.com/imaginekube/test:v1", ExImage: Image{Domain: "dockerhub.qingcloud.com", Tag: "v1", Path: "imaginekube/test"}},
		{inputImageName: "harbor.devops.imaginekube.local:30280/library/tomcat:latest", ExImage: Image{Domain: "harbor.devops.imaginekube.local:30280", Tag: "latest", Path: "library/tomcat"}},
		...
		{inputImageName: "imaginekube/ks-account:v2.1.0", ExImage: Image{Domain: "docker.io", Tag: "v2.1.0", Path: "imaginekube/ks-account"}},
		{inputImageName: "http://docker.io/nginx:latest", ExImage: Image{}},
		{inputImageName: "https://harbor.devops.imaginekube.local:30280/library/tomcat:latest", ExImage: Image{}},
...
func TestStringWithoutScheme(t *testing.T) {
	...
	testRawurls := []testRawUrl{
		{"http://dockerhub.qingcloud.com/imaginekube/nginx:v1", "dockerhub.qingcloud.com/imaginekube/nginx:v1"},
		{"https://dockerhub.qingcloud.com/imaginekube/nginx:v1", "dockerhub.qingcloud.com/imaginekube/nginx:v1"},
		{"http://harbor.devops.imaginekube.local:30280/library/tomcat:latest", "harbor.devops.imaginekube.local:30280/library/tomcat:latest"},
		{"https://harbor.devops.imaginekube.local:30280/library/tomcat:latest", "harbor.devops.imaginekube.local:30280/library/tomcat:latest"},
	}
