...
const (
	servicemeshEnabled         = "servicemesh.imaginekube.com/enabled"
	sidecarInject              = "sidecar.istio.io/inject"
	ingressControllerFolder    = "/etc/imaginekube/ingress-controller"
	ingressControllerPrefix    = "imaginekube-router-"
	ingressControllerNamespace = "imaginekube-controls-system"
