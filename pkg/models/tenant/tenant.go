...
import (
	...
	auditingv1alpha1 "imaginekube.com/imaginekube/pkg/api/auditing/v1alpha1"
	eventsv1alpha1 "imaginekube.com/imaginekube/pkg/api/events/v1alpha1"
	loggingv1alpha2 "imaginekube.com/imaginekube/pkg/api/logging/v1alpha2"
	meteringv1alpha1 "imaginekube.com/imaginekube/pkg/api/metering/v1alpha1"
	...
	"imaginekube.com/imaginekube/pkg/models/auditing"
	"imaginekube.com/imaginekube/pkg/models/events"
	"imaginekube.com/imaginekube/pkg/models/iam/am"
	"imaginekube.com/imaginekube/pkg/models/iam/im"
	"imaginekube.com/imaginekube/pkg/models/logging"
	"imaginekube.com/imaginekube/pkg/models/metering"
	"imaginekube.com/imaginekube/pkg/models/monitoring"
	"imaginekube.com/imaginekube/pkg/models/openpitrix"
	resources "imaginekube.com/imaginekube/pkg/models/resources/v1alpha3"
	resourcesv1alpha3 "imaginekube.com/imaginekube/pkg/models/resources/v1alpha3/resource"
	resourcev1alpha3 "imaginekube.com/imaginekube/pkg/models/resources/v1alpha3/resource"
	auditingclient "imaginekube.com/imaginekube/pkg/simple/client/auditing"
	eventsclient "imaginekube.com/imaginekube/pkg/simple/client/events"
	loggingclient "imaginekube.com/imaginekube/pkg/simple/client/logging"
	...
	jsonpatchutil "imaginekube.com/imaginekube/pkg/utils/josnpatchutil"
	"imaginekube.com/imaginekube/pkg/utils/stringutils"
)

const orphanFinalizer = "orphan.finalizers.imaginekube.com"
...
func New(informers informers.InformerFactory, k8sclient kubernetes.Interface, ksclient imaginekube.Interface, evtsClient eventsclient.Client, loggingClient loggingclient.Client, auditingclient auditingclient.Client, am am.AccessManagementInterface, im im.IdentityManagementInterface, authorizer authorizer.Authorizer, monitoringclient monitoringclient.Interface, resourceGetter *resourcev1alpha3.ResourceGetter, opClient openpitrix.Interface) Interface {
	return &tenantOperator{
		...
		opRelease:      opClient,
		clusterClient:  clusterclient.NewClusterClient(informers.ImagineKubeSharedInformerFactory().Cluster().V1alpha1().Clusters()),
	}
}
...
// labelNamespaceWithWorkspaceName adds a imaginekube.com/workspace=[workspaceName] label to namespace which
...
func (t *tenantOperator) ListClusters(user user.Info, queryParam *query.Query) (*api.ListResult, error) {
	...
	listClustersInGlobalScope := authorizer.AttributesRecord{
		User:            user,
		Verb:            "list",
		APIGroup:        "cluster.imaginekube.com",
		Resource:        "clusters",
		ResourceScope:   request.GlobalScope,
		ResourceRequest: true,
	}
...
func (t *tenantOperator) getClusterRoleBindingsByUser(clusterName, user string) (*rbacv1.ClusterRoleBindingList, error) {
	...
	return kubernetesClientSet.RbacV1().ClusterRoleBindings().
		List(context.Background(),
			metav1.ListOptions{LabelSelector: labels.FormatLabels(map[string]string{"iam.imaginekube.com/user-ref": user})})
}
...
func (t *tenantOperator) checkClusterPermission(user user.Info, clusters []string) error {
	...
	for _, clusterName := range clusters {
		...
		if cluster.Labels["cluster.imaginekube.com/visibility"] == "public" {
			continue
		}
