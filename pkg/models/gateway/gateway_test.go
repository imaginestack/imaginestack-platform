...
import (
	...
	"imaginekube.com/api/gateway/v1alpha1"
...
func Test_gatewayOperator_GetGateways(t *testing.T) {
	...
	client.Create(context.TODO(), &v1alpha1.Gateway{
		ObjectMeta: v1.ObjectMeta{
			Name:      "imaginekube-router-project3",
			Namespace: "project3",
		},
	})
	...
	client.Create(context.TODO(), &v1alpha1.Gateway{
		ObjectMeta: v1.ObjectMeta{
			Name:      "imaginekube-router-project4",
	...
	tests := []struct {
		...
		},
		{
			...
			want: wantedResult("imaginekube-router-project3", "project3"),
		},
		{
			...
			want: wantedResult("imaginekube-router-project4", "imaginekube-controls-system"),
		},
		{
			...
			want: wantedResult("imaginekube-router-imaginekube-system", "imaginekube-controls-system"),
		},
		{
	...
	return []*v1alpha1.Gateway{
		{
			TypeMeta: v1.TypeMeta{
				Kind:       "Gateway",
				APIVersion: "gateway.imaginekube.com/v1alpha1",
			},
			ObjectMeta: v1.ObjectMeta{
				Name:            name,
				Namespace:       namspace,
...
func create_GlobalGateway(c client.Client) *v1alpha1.Gateway {
	g := &v1alpha1.Gateway{
		ObjectMeta: v1.ObjectMeta{
			Name:      "imaginekube-router-imaginekube-system",
			Namespace: "imaginekube-controls-system",
		},
	}
...
func Test_gatewayOperator_DeleteGateway(t *testing.T) {
	...
	client.Create(context.TODO(), &v1alpha1.Gateway{
		ObjectMeta: v1.ObjectMeta{
			Name:      "imaginekube-router-project1",
			Namespace: "project1",
		},
	})
...
func Test_gatewayOperator_UpgradeGateway(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			want: &v1alpha1.Gateway{
				ObjectMeta: v1.ObjectMeta{
					Name:            "imaginekube-router-project2",
					Namespace:       "imaginekube-controls-system",
					ResourceVersion: "1",
				},
				Spec: v1alpha1.GatewaySpec{
