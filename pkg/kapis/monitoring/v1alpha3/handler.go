...
import (
	...
	converter "imaginekube.com/monitoring-dashboard/tools/converter"
...
func (h handler) handleImagineKubeMetricsQuery(req *restful.Request, resp *restful.Response) {
	res := h.mo.GetImagineKubeStats()
...
// handleGrafanaDashboardImport imports Grafana template and converts it to ImagineKube dashboard.
...
func (h handler) handleGrafanaDashboardImport(req *restful.Request, resp *restful.Response) {
	...
	ctx := context.TODO()
	annotation := map[string]string{"imaginekube.com/description": entity.Description}
