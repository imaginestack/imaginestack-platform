...
import (
	...
	"imaginekube.com/imaginekube/pkg/models/components"
	"imaginekube.com/imaginekube/pkg/models/git"
	"imaginekube.com/imaginekube/pkg/models/kubeconfig"
	"imaginekube.com/imaginekube/pkg/models/kubectl"
	"imaginekube.com/imaginekube/pkg/models/quotas"
	"imaginekube.com/imaginekube/pkg/models/registries"
	"imaginekube.com/imaginekube/pkg/models/resources/v1alpha2"
	"imaginekube.com/imaginekube/pkg/models/resources/v1alpha2/resource"
	"imaginekube.com/imaginekube/pkg/models/revisions"
	"imaginekube.com/imaginekube/pkg/models/routers"
...
func newResourceHandler(k8sClient kubernetes.Interface, factory informers.InformerFactory, masterURL string) *resourceHandler {
	...
	return &resourceHandler{
		...
		kubectlOperator: kubectl.NewOperator(nil, factory.KubernetesSharedInformerFactory().Apps().V1().Deployments(),
			...
			factory.ImagineKubeSharedInformerFactory().Iam().V1alpha2().Users(), ""),
	}
}
