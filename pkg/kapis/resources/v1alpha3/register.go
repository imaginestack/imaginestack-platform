...
import (
	...
	"imaginekube.com/imaginekube/pkg/api/resource/v1alpha2"
	...
	v2 "imaginekube.com/imaginekube/pkg/models/registries/v2"
...
const (
	GroupName = "resources.imaginekube.com"
...
func AddToContainer(c *restful.Container, informerFactory informers.InformerFactory, cache cache.Cache) error {
	...
	webservice.Route(webservice.GET("/namespaces/{namespace}/imageconfig").
		...
		Param(webservice.QueryParameter("image", "Image name to query, e.g. imaginekube/ks-apiserver:v3.1.1").Required(true)).
		Metadata(restfulspec.KeyOpenAPITags, []string{tagNamespacedResource}).
