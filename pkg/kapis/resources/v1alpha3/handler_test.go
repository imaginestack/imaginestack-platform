...
import (
	...
	resourcev1alpha2 "imaginekube.com/imaginekube/pkg/models/resources/v1alpha2/resource"
	"imaginekube.com/imaginekube/pkg/models/resources/v1alpha3/resource"
...
func TestHandleGetComponentStatus(t *testing.T) {
	...
	request, response, err := buildReqAndRes("GET", "/kapis/resources.imaginekube.com/v1alpha3/components/{component}", param, nil)
	if err != nil {
...
func TestHandleGetComponents(t *testing.T) {
	request, response, err := buildReqAndRes("GET", "/kapis/resources.imaginekube.com/v1alpha3/components", nil, nil)
	if err != nil {
		t.Fatal("build res or req failed ")
	}
	handler, err := prepare()
