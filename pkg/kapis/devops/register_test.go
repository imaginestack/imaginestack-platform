/*
Copyright 2022 The ImagineKube Authors.
...
func TestAddToContainer(t *testing.T) {
	...
	tests := []struct {
		...
		name: "Should proxy devops.imaginekube.com/v1alpha1 API properly",
		args: args{
			target:         "/kapis/devops.imaginekube.com/v1alpha1/resources",
			mockAPIPattern: "/kapis/devops.imaginekube.com/v1alpha1/resources",
			mockResponse:   fakeResponse,
		},
		wantResponse: notFoundResponse,
	}, {
		name: "Should proxy devops.imaginekube.com/v1alpha2 API properly",
		args: args{
			target:         "/kapis/devops.imaginekube.com/v1alpha2/resources",
			mockAPIPattern: "/kapis/devops.imaginekube.com/v1alpha2/resources",
			mockResponse:   fakeResponse,
		},
		wantResponse: fakeResponse,
	}, {
		name: "Should proxy devops.imaginekube.com/v1alpha3 API properly",
		args: args{
			target:         "/kapis/devops.imaginekube.com/v1alpha3/resources",
			mockAPIPattern: "/kapis/devops.imaginekube.com/v1alpha3/resources",
			mockResponse:   fakeResponse,
		},
		wantResponse: fakeResponse,
	}, {
		name: "Should proxy gitops.imaginekube.com/v1alpha1 API properly",
		args: args{
			target:         "/kapis/gitops.imaginekube.com/v1alpha1/resources",
			mockAPIPattern: "/kapis/gitops.imaginekube.com/v1alpha1/resources",
			mockResponse:   fakeResponse,
		},
		wantResponse: fakeResponse,
	}, {
		...
		args: args{
			target:         "/kapis/devops.imaginekube.com/v1alpha3/resources",
			mockAPIPattern: "/kapis/gitops.imaginekube.com/v1alpha3/resources",
		},
		wantResponse: notFoundResponse,
	},
		{
			...
			args: args{
				target:         "/kapis/devops.imaginekube.com/v1alpha123/resources",
				mockAPIPattern: "/kapis/devops.imaginekube.com/v1alpha123/resources",
			},
			wantResponse: notFoundResponse,
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			// mock to request DevOps API from ImagineKube APIServer
