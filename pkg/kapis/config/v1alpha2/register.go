...
import (
	...
	imaginekubeconfig "imaginekube.com/imaginekube/pkg/apiserver/config"
	"imaginekube.com/imaginekube/pkg/apiserver/runtime"
)

const (
	GroupName = "config.imaginekube.com"
)

var GroupVersion = schema.GroupVersion{Group: GroupName, Version: "v1alpha2"}

func AddToContainer(c *restful.Container, config *imaginekubeconfig.Config) error {
