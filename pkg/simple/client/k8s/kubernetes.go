...
type Client interface {
	...
	ImagineKube() imaginekube.Interface
...
func NewKubernetesClientOrDie(options *KubernetesOptions) Client {
	...
	k := &kubernetesClient{
		...
		ks:            imaginekube.NewForConfigOrDie(config),
...
func NewKubernetesClient(options *KubernetesOptions) (Client, error) {
	...
	k.ks, err = imaginekube.NewForConfig(config)
	if err != nil {
		return nil, err
	}
...
func (k *kubernetesClient) ImagineKube() imaginekube.Interface {
	return k.ks
}
