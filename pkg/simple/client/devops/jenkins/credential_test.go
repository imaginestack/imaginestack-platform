...
func TestNewUsernamePasswordCredential(t *testing.T) {
	...
	secret := &v1.Secret{
		...
		Type: "credential.devops.imaginekube.com/basic-auth",
	}
...
func TestNewSshCredential(t *testing.T) {
	...
	secret := &v1.Secret{
		...
		Type: "credential.devops.imaginekube.com/ssh-auth",
	}
...
func TestNewKubeconfigCredential(t *testing.T) {
	...
	secret := &v1.Secret{
		...
		Type: "credential.devops.imaginekube.com/kubeconfig",
...
func TestNewSecretTextCredential(t *testing.T) {
	...
	secret := &v1.Secret{
		...
		Type: "credential.devops.imaginekube.com/secret-text",
