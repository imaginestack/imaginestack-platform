...
type Options struct {
	...
	// this value will be set by the cluster-controller and stored in the imaginekube-config configmap.
...
func (o *Options) AddFlags(fs *pflag.FlagSet, s *Options) {
	fs.BoolVar(&o.Enable, "multiple-clusters", s.Enable, ""+
		"This field instructs ImagineKube to enter multiple-cluster mode or not.")
	...
	fs.StringVar(&o.ProxyPublishService, "proxy-publish-service", s.ProxyPublishService, ""+
		...
		"For example, tower.imaginekube-system.svc.")
