        ...
        "groups": [
            {
                ...
                "file": "/etc/prometheus/rules/prometheus-k8s-rulefiles-0/imaginekube-monitoring-system-prometheus-k8s-rules.yaml",
                "rules": [
                    {
                        "state": "firing",
                        ...
                        "alerts": [
                            {
                                ...
                                "state": "firing",
                                "activeAt": "2023-09-22T06:18:47.55260138Z",
                                "value": "4.405e-01"
                            }
                        ],
                        "health": "ok",
                        "evaluationTime": 0.000894038,
                        "lastEvaluation": "2023-09-22T08:57:17.566233983Z",
                        "type": "alerting"
                    }
                ]
            }
