                        ...
                        "should":[
                            {
                                "bool":{
                                    "filter":[
                                        {
                                            "match_phrase":{
                                                "ObjectRef.Namespace.keyword":"imaginekube-system"
                                            }
                                        },
                                        {
                                            "range":{
                                                "RequestReceivedTimestamp":{
                                                    "gte":"2023-01-01T01:01:01.000000001Z"
                                                }
                                            }
                                        }
                                    ]
                ...
                },
                {
                    "bool":{
                        "should":[
                            {
                                "match_phrase":{
                                    "User.Username.keyword":"system:serviceaccount:imaginekube-system:imaginekube"
                                }
                            }
                        ],
                        "minimum_should_match":1
                ...
                },
                {
                    "range":{
                        "RequestReceivedTimestamp":{
                            ...
                            "lte":"2023-01-01T01:01:01.000000001Z"
                        }
                    }
                }
            ]
...
`
	...
	filter := &auditing.Filter{
		...
		Verbs:                 []string{"create"},
		Users:                 []string{"system:serviceaccount:imaginekube-system:imaginekube"},
