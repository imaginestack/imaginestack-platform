...
import (
	...
	"imaginekube.com/imaginekube/pkg/simple/client/network/utils"
)
...
func NewIPAMClient(client imaginekube.Interface, typeStr string) IPAMClient {
	return IPAMClient{
		typeStr: typeStr,
		client:  client,
	}
