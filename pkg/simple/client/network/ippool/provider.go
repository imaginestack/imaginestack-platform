...
import (
	...
	calicoclient "imaginekube.com/imaginekube/pkg/simple/client/network/ippool/calico"
	"imaginekube.com/imaginekube/pkg/simple/client/network/ippool/ipam"
)
...
func newProvider(clientset imaginekubeclient.Interface) provider {
	return provider{
		imaginekubeClient: clientset,
		ipamclient:       ipam.NewIPAMClient(clientset, networkv1alpha1.VLAN),
	}
}

func NewProvider(k8sInformer k8sinformers.SharedInformerFactory, clientset imaginekubeclient.Interface, client clientset.Interface, pt string, k8sOptions *k8s.KubernetesOptions) Provider {
	var p Provider
