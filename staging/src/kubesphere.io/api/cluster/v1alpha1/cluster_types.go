...
const (
	...
	HostCluster = "cluster-role.imaginekube.com/host"
	// Description of which region the cluster been placed
	ClusterRegion = "cluster.imaginekube.com/region"
	// Name of the cluster group
	ClusterGroup = "cluster.imaginekube.com/group"

	Finalizer = "finalizer.cluster.imaginekube.com"
)
...
type Connection struct {
	...
	//   kubeconfig and imaginekube apiserver endpoint provided
	// ConnectionTypeProxy means using imaginekube proxy, no kubeconfig
	//   or imaginekube apiserver endpoint required
	Type ConnectionType `json:"type,omitempty"`

	// ImagineKube API Server endpoint. Example: http://10.10.0.11:8080
	...
	ImagineKubeAPIEndpoint string `json:"imaginekubeAPIEndpoint,omitempty"`
	...
	// ImagineKubeAPIServerPort is the port which listens for forwarding imaginekube apigateway traffic
	// Only applicable when connection type is proxy.
	ImagineKubeAPIServerPort uint16 `json:"imaginekubeAPIServerPort,omitempty"`
}
...
type ClusterStatus struct {
	...
	ImagineKubeVersion string `json:"kubeSphereVersion,omitempty"`
