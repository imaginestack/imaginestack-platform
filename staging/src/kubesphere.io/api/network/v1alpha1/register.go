...
// +k8s:conversion-gen=imaginekube.com/api/network
// +k8s:defaulter-gen=TypeMeta
// +groupName=network.imaginekube.com
package v1alpha1
...
var (
	...
	SchemeGroupVersion = schema.GroupVersion{Group: "network.imaginekube.com", Version: "v1alpha1"}
