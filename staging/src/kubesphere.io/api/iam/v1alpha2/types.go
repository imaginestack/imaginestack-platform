...
const (
	...
	RegoOverrideAnnotation                = "iam.imaginekube.com/rego-override"
	AggregationRolesAnnotation            = "iam.imaginekube.com/aggregation-roles"
	GlobalRoleAnnotation                  = "iam.imaginekube.com/globalrole"
	WorkspaceRoleAnnotation               = "iam.imaginekube.com/workspacerole"
	ClusterRoleAnnotation                 = "iam.imaginekube.com/clusterrole"
	GrantedClustersAnnotation             = "iam.imaginekube.com/granted-clusters"
	UninitializedAnnotation               = "iam.imaginekube.com/uninitialized"
	LastPasswordChangeTimeAnnotation      = "iam.imaginekube.com/last-password-change-time"
	RoleAnnotation                        = "iam.imaginekube.com/role"
	RoleTemplateLabel                     = "iam.imaginekube.com/role-template"
	ScopeLabelFormat                      = "scope.imaginekube.com/%s"
	UserReferenceLabel                    = "iam.imaginekube.com/user-ref"
	IdentifyProviderLabel                 = "iam.imaginekube.com/identify-provider"
	OriginUIDLabel                        = "iam.imaginekube.com/origin-uid"
	ServiceAccountReferenceLabel          = "iam.imaginekube.com/serviceaccount-ref"
	FieldEmail                            = "email"
...
// +genclient:nonNamespaced
// +kubebuilder:object:root=true
// +kubebuilder:printcolumn:name="Workspace",type="string",JSONPath=".metadata.labels.imaginekube\\.io/workspace"
// +kubebuilder:printcolumn:name="Alias",type="string",JSONPath=".metadata.annotations.imaginekube\\.io/alias-name"
// +kubebuilder:resource:categories="iam",scope="Cluster"
// +kubebuilder:object:root=true
