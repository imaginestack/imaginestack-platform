...
const (
	...
	ApplicationInstance = "app.imaginekube.com/instance"

	RepoSyncPeriod          = "app.imaginekube.com/sync-period"
	OriginWorkspaceLabelKey = "imaginekube.com/workspace-origin"
)
