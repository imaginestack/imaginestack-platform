...
func TestStorageStrategy(t *testing.T) {
	...
	created := &Strategy{
		TypeMeta: metav1.TypeMeta{
			Kind:       "Strategy",
			APIVersion: "servicemesh.imaginekube.com/v1alpha2",
		},
...
func TestStrategyRead(t *testing.T) {
	...
	var str []byte
	file, err := os.ReadFile("/Users/zry/go/src/imaginekube.com/imaginekube/config/samples/servicemesh_v1alpha2_strategy.yaml")
	if err == nil {
