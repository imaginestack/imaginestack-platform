...
// TODO: to be remoted once we move imaginekube.com/apis out of imaginekube package
...
func (c *groups) CreateBinding(ctx context.Context, workspace, group, user string) (result string, err error) {
	...
	resp, err := c.client.R().
		...
		Post("/kapis/iam.imaginekube.com/v1alpha2/workspaces/{workspace}/groupbindings")
