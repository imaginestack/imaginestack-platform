...
import (
	...
	"imaginekube.com/client-go/restclient"

	"imaginekube.com/imaginekube/pkg/apis"
	"imaginekube.com/imaginekube/pkg/constants"
	"imaginekube.com/imaginekube/test/e2e/framework/workspace"
)
...
func NewImagineKubeFramework(baseName string) ImagineKubeFramework {

	sch := runtime.NewScheme()
	if err := apis.AddToScheme(sch); err != nil {
		Failf("unable add ImagineKube APIs to scheme: %v", err)
	}
...
func (f *Framework) ImagineKubeSystemNamespace() string {
