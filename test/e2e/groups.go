...
import (
	...
	"imaginekube.com/api/iam/v1alpha2"

	"imaginekube.com/imaginekube/pkg/utils/stringutils"
	"imaginekube.com/imaginekube/test/e2e/constant"
	"imaginekube.com/imaginekube/test/e2e/framework"
	"imaginekube.com/imaginekube/test/e2e/framework/iam"
	"imaginekube.com/imaginekube/test/e2e/framework/resource"
...
var _ = Describe("Groups", func() {
	f := framework.NewImagineKubeFramework("group")
...
func CheckNamespaceAccess(f framework.ImagineKubeFramework, c client.Client, namespace string) error {
	_, err := resource.ListPods(c, namespace)
	return err
}

// Create a user and wait until the user became active status.
func createUserWithWait(f framework.ImagineKubeFramework, c client.Client, username string) (*v1alpha2.User, error) {
